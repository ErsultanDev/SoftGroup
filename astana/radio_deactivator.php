...
<head>
    ...
    <title>Радиочастотный деактиватор купить в Нур-Султан | Антикражные системы от SoftGroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Радиочастотный деактиватор, антикражный, для магазина, купить, Нур-Султан, цена, продажа." />
    <meta name="description" content="Купить Антикражный радиочастотный деактиваторв Нур-Султан по низким ценам. У нас имеется широкий ассортимент высококачественных антикражных систем от SoftGroup.">
    <!--//tags -->
...
<body>
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="radio_deactivator.php">Нур-Султан</a></li>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Радиочастотный деактиватор в Нур-Султан</h1>
            <!--//w3_short-->
        </div>
    </div>
