...
<head>
    ...
    <title>Сканер для считывания штрих кодов купить в Нур-Султан по низким ценам - Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="сканер для считывания штрих кодов, купить, для кассы, Нур-Султан, для магазина, цена, продажа." />
    <meta name="description" content="Высококачественный светодиодный сканер для считывания штрих кодов купить в Нур-Султан. Широкий выбор сканеров для считывания штрих кода от Softgroup">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="scanner_t_5.php">Нур-Султан</a></li>
