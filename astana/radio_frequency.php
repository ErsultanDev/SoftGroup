...
<head>
    ...
    <title>Антикражные системы в Нур-Султан | Антикражные ворота радиочастотные купить</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="антикражные системы, антикражные ворота, радиочастотные, для магазина, купить, Нур-Султан, цена, продажа." />
    <meta name="description" content="Купить антикражные ворота для магазина в Нур-Султан по низким ценам. У нас имеется широкий ассортимент высококачественных антикражных систем.">
    <!--//tags -->
...
<body>
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="radio_frequency.php">Нур-Султан</a></li>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Антикражные системы в Нур-Султан</h1>
            <!--//w3_short-->
        </div>
    </div>
