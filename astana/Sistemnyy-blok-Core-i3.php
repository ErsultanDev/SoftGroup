...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        ...
        <meta name="keywords" content=" купить системный блок, AMD, CORE, купить, Нур-Султан, цена, продажа." />
        <meta name="description" content="Купить Системный блок  в Нур-Султан по низким ценам. Осуществляем продажу игровых системных блоков.">
        <!--//tags -->
