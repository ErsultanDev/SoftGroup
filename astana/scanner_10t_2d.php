...
<head>
    ...
    <title>Cканер QR и штрих-кодов в Нур-Султан | Купить Сканер ручной для QR кодов</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="сканер штрих кода, сканер qr кода, для кассы, для магазина, Нур-Султан, купить, цена, продажа." />
    <meta name="description" content="Высококачественный имиджевый сканер QR и штрих-кодов в Нур-Султан по доступным ценам. Осуществляем продажу сканеров штрих кода от Softgroup">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="scanner_10t_2d.php">Нур-Султан</a></li>
