...
<head>
    ...
    <title>Весы с печатью этикеток TM-30A купить в Нур-Султан от компании Softgroup</title>
    <!--/tags -->
    ...
    <meta name="description" content="Электронные весы с печатью этикеток купить в Нур-Султан. Огромный выбор электронных весов. Купить электронные весы с печатью в Нур-Султан.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="scale_tm30.php">Нур-Султан</a></li>
